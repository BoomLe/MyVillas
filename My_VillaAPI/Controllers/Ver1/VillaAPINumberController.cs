    ...
    public class VillaAPINumberController : ControllerBase
    {
        ...
        public async Task<ActionResult<APIResponse>> CreateVillaNumber([FromBody] VillanumberCreateDTO createDTO)
        {
            try
            {
                ...
                {
                    ModelState.AddModelError("ErrorMessages", "Tên này đã tồn tại!");
                    return BadRequest(ModelState);
                }
                if (await _dbVilla.GetAsync(u => u.Id == createDTO.VillaId) == null)
                {
                    ModelState.AddModelError("ErrorMessages", "tên ID không hợp lệ !");
                    return BadRequest(ModelState);
                }
                if (createDTO == null)
                {
        ...
        public async Task<ActionResult<APIResponse>> UpdateVillaNumber(int id, [FromBody] VillanumberUpdateDTO updateDTO)
        {
            try
            {
                ...
                {
                    ModelState.AddModelError("ErrorMessages", "Tên không hợp lệ !");
                    return BadRequest(ModelState);
                }
