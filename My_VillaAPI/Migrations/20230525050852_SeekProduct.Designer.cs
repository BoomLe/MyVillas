...
namespace My_VillaAPI.Migrations
{
    ...
    [Migration("20230525050852_SeekProduct")]
    partial class SeekProduct
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("My_VillaAPI.Models.Villa", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Rate = 200.0,
                            Sqft = 550,
                            UpdateDate = new DateTime(2023, 5, 25, 12, 8, 52, 840, DateTimeKind.Local).AddTicks(9481)
                        },
                        new
                        {
                            Id = 2,
                            ...
                            Rate = 200.0,
                            Sqft = 550,
                            UpdateDate = new DateTime(2023, 5, 25, 12, 8, 52, 840, DateTimeKind.Local).AddTicks(9493)
                        },
                        new
                        {
                            Id = 3,
                            ...
                            Rate = 200.0,
                            Sqft = 550,
                            UpdateDate = new DateTime(2023, 5, 25, 12, 8, 52, 840, DateTimeKind.Local).AddTicks(9495)
                        },
                        new
                        {
                            Id = 4,
                            ...
                            Rate = 200.0,
                            Sqft = 550,
                            UpdateDate = new DateTime(2023, 5, 25, 12, 8, 52, 840, DateTimeKind.Local).AddTicks(9496)
                        },
                        new
                        {
                            Id = 5,
                            ...
                            Rate = 200.0,
                            Sqft = 550,
                            UpdateDate = new DateTime(2023, 5, 25, 12, 8, 52, 840, DateTimeKind.Local).AddTicks(9498)
                        },
                        new
                        {
                            Id = 6,
                            ...
                            Rate = 200.0,
                            Sqft = 550,
                            UpdateDate = new DateTime(2023, 5, 25, 12, 8, 52, 840, DateTimeKind.Local).AddTicks(9500)
                        });
                });
