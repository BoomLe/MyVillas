...
namespace My_VillaAPI.Migrations
{
    ...
    [Migration("20230526073459_ModelVillaNumberDb")]
    partial class ModelVillaNumberDb
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("My_VillaAPI.Models.Villa", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Rate = 200.0,
                            Sqft = 550,
                            UpdateDate = new DateTime(2023, 5, 26, 14, 34, 59, 442, DateTimeKind.Local).AddTicks(1136)
                        },
                        new
                        {
                            Id = 2,
                            ...
                            Rate = 200.0,
                            Sqft = 550,
                            UpdateDate = new DateTime(2023, 5, 26, 14, 34, 59, 442, DateTimeKind.Local).AddTicks(1154)
                        },
                        new
                        {
                            Id = 3,
                            ...
                            Rate = 200.0,
                            Sqft = 550,
                            UpdateDate = new DateTime(2023, 5, 26, 14, 34, 59, 442, DateTimeKind.Local).AddTicks(1158)
                        },
                        new
                        {
                            Id = 4,
                            ...
                            Rate = 200.0,
                            Sqft = 550,
                            UpdateDate = new DateTime(2023, 5, 26, 14, 34, 59, 442, DateTimeKind.Local).AddTicks(1161)
                        },
                        new
                        {
                            Id = 5,
                            ...
                            Rate = 200.0,
                            Sqft = 550,
                            UpdateDate = new DateTime(2023, 5, 26, 14, 34, 59, 442, DateTimeKind.Local).AddTicks(1165)
                        },
                        new
                        {
                            Id = 6,
                            ...
                            Rate = 200.0,
                            Sqft = 550,
                            UpdateDate = new DateTime(2023, 5, 26, 14, 34, 59, 442, DateTimeKind.Local).AddTicks(1168)
                        });
                });
