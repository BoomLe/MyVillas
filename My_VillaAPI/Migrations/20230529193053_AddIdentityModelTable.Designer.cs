...
namespace My_VillaAPI.Migrations
{
    ...
    [Migration("20230529193053_AddIdentityModelTable")]
    partial class AddIdentityModelTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("My_VillaAPI.Models.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("My_VillaAPI.Models.LocalUser", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("My_VillaAPI.Models.Villa", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Rate = 200.0,
                            Sqft = 550,
                            UpdateDate = new DateTime(2023, 5, 30, 2, 30, 53, 313, DateTimeKind.Local).AddTicks(961)
                        },
                        new
                        {
                            Id = 2,
                            ...
                            Rate = 200.0,
                            Sqft = 550,
                            UpdateDate = new DateTime(2023, 5, 30, 2, 30, 53, 313, DateTimeKind.Local).AddTicks(984)
                        },
                        new
                        {
                            Id = 3,
                            ...
                            Rate = 200.0,
                            Sqft = 550,
                            UpdateDate = new DateTime(2023, 5, 30, 2, 30, 53, 313, DateTimeKind.Local).AddTicks(986)
                        },
                        new
                        {
                            Id = 4,
                            ...
                            Rate = 200.0,
                            Sqft = 550,
                            UpdateDate = new DateTime(2023, 5, 30, 2, 30, 53, 313, DateTimeKind.Local).AddTicks(987)
                        },
                        new
                        {
                            Id = 5,
                            ...
                            Rate = 200.0,
                            Sqft = 550,
                            UpdateDate = new DateTime(2023, 5, 30, 2, 30, 53, 313, DateTimeKind.Local).AddTicks(989)
                        },
                        new
                        {
                            Id = 6,
                            ...
                            Rate = 200.0,
                            Sqft = 550,
                            UpdateDate = new DateTime(2023, 5, 30, 2, 30, 53, 313, DateTimeKind.Local).AddTicks(990)
                        });
                });
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("My_VillaAPI.Models.ApplicationUser", null)
                        .WithMany()
